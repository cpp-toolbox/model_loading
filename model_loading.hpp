...
std::vector<IVPTextured> parse_model_into_ivpts(const std::string &model_path, bool flip_uvs = false);
std::vector<IVPNTextured> parse_model_into_ivpnts(const std::string &model_path, bool flip_uvs = false);
